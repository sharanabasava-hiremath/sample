...
<html>
  ...
  <body ng-app="userHomepageApp" ng-controller="userHomepageCtrl">
    ...
    <div class="container">
      ...
      <div class="jumbotron">
	  <h3 class="welcome-text">Choose Area to Park</h3>
	<div id="map-canvas">
        ...
        var infoContent = '<div id="iw-container">' +
          '<div class="" >' +                       
               '<div class="iw-content">' +                 
                ...
                '</div>' +                  
                '<div class="iw-subTitle">' +
                '<a href="./displayPage.php?locationid='+this.name.parkingspace_id+'"><button type="submit" class="btn btn-xs btn-success btn pull-right" style="margin-right:10px; margin-bottom:10px" >Check Available Slots</button></a>' +
                '</div>' +
              '</div>' +
